...
-- often caused by Middle East conflicts & geopolitical events.
-- ============================================================
SELECT
    year,
...
-- ============================================================
-- QUERY 6: Correlation Indicator
-- Measures co-movement: when oil spikes, does inflation follow?
-- ============================================================
SELECT
    year,
    ROUND(inflation_pct, 2)             AS india_inflation,
    ...
    CASE
        WHEN oil_price_shock_pct > 15 AND inflation_pct > 6
            THEN '⚠️ HIGH RISK — Shock & Inflation Spike'
        WHEN oil_price_shock_pct > 15 AND inflation_pct <= 6
